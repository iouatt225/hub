...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    problem: 'Les agriculteurs urbains manquent de données sur l\'humidité et la qualité des sols.',
  ...
  },
  {
    ...
    problem: 'Problèmes récurrents de transport pour se rendre au campus depuis certains quartiers.',
  ...
  },
  {
    ...
    problem: 'Multiplicité des cartes et moyens de paiement à la cafétéria, bibliothèque et administration.',
    ...
    votes: 45,
    commentCount: 2,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(), // Il y a 5 heures
  },
  {
    id: 'proj-4',
    title: 'Plateforme de mentorat Alumni-Étudiants',
    problem: 'Difficile de trouver un mentor dans le réseau des anciens qui correspond à ses aspirations.',
