...
export function RegisterModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[500px] p-8 sm:p-10 rounded-[2.5rem] shadow-2xl bg-surface border border-border/50">
        <DialogHeader className="flex flex-col items-center text-center pb-6">
          ...
          <DialogTitle className="text-3xl font-black text-text-primary tracking-tight">Créer un compte</DialogTitle>
