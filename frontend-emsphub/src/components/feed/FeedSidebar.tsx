        ...
        <CardContent className="p-5 pt-0">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-background-alt p-3.5 rounded-xl border border-border/50 text-center">
              <span className="text-xl font-extrabold text-text-primary block mb-0.5">{MOCK_DASHBOARD_KPIS.totalProjects}</span>
              <span className="text-[10px] text-text-muted font-medium">Projets</span>
            </div>
            <div className="bg-background-alt p-3.5 rounded-xl border border-border/50 text-center">
              <span className="text-xl font-extrabold text-text-primary block mb-0.5">{MOCK_DASHBOARD_KPIS.totalUsers}</span>
              <span className="text-[10px] text-text-muted font-medium">Créateurs</span>
            </div>
            <div className="bg-background-alt p-3.5 rounded-xl border border-border/50 text-center">
              <span className="text-xl font-extrabold text-text-primary block mb-0.5">{MOCK_DASHBOARD_KPIS.totalVotes}</span>
              <span className="text-[10px] text-text-muted font-medium">Votes</span>
            </div>
            <div className="bg-background-alt p-3.5 rounded-xl border border-border/50 text-center">
              <span className="text-xl font-extrabold text-text-primary block mb-0.5">{MOCK_DASHBOARD_KPIS.engagementRate}%</span>
